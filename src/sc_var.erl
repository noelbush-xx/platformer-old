...
%% @reference <span style="padding:0.1em 0.4em;background-color:#efe;display:inline-block;width:47em"><span style="display:inline-block;width:18em">This build was released</span><tt style="text-decoration:underline;background-color:#eee">$Date: 2009-05-06 06:02:09 +0200 (Wed, 06 May 2009) $</tt></span>
...
-svn_id("$Id: sc_var.erl 364 2009-05-06 04:02:09Z john $").
-svn_head("$HeadURL: svn://crunchyd.com/scutil/erl/src/sc_var.erl $").
-svn_revision("$Revision: 364 $").
